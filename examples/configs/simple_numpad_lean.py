# Simple Numpad - Lean Configuration
# Physical layout: [7][8][9][*]
#                 [4][5][6][-]  
#                 [1][2][3][+]
#                 [/][0][.][⏎]
...
# Simple keymap - just the essentials (Key.RxCx -> keycode)
KEYMAP = {
    # Row 0 (top): 7, 8, 9, *
...
for k in number_keys:
    SIMPLE_COLORS[k] = Color.BLUE
# Operators (yellow)
for k in operator_keys:
    SIMPLE_COLORS[k] = Color.YELLOW
# Enter (green)
SIMPLE_COLORS[Key.R3C3] = Color.GREEN

# Export full configuration expected by code.py
LAYERS, COLORS, CONFIG = create_simple_keymap(KEYMAP, SIMPLE_COLORS, "Simple Numpad (Lean)")
